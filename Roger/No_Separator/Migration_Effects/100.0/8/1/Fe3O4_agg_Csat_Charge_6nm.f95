...
module user_input
SAVE    
     parameter(N=2,NJ=102,Numbertimesteps=3.6d3*2000,tmax=3.6d3*2000)
     ! 3.6d3 = 1 hour
     ...
     double precision :: z_cat = 1.0, diff_cat = 1.00d-6
                    ! ANION
     double precision :: z_an = -1.0, diff_an = 1.00d-6/2.0 * 10.0
